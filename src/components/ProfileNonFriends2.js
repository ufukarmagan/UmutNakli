...
import ContentNonFriend2 from './ContentNonFriend2';
    ...
    constructor(props) {
      ...
      renderRow() {
        ...
        if (this.state.postlarigetir === 'hayir') {
            ...
            return <ContentNonFriend2 age={this.props.age} userDisase={this.props.userDisase} province={this.props.province} />;
        }                
            ...
            <ScrollView style={styles.container}>
                <View style={styles.subContainerStyle} >
                    ...
                    <View style={{ flex: 2, justifyContent: 'center', alignItems: 'center' }} >
                        <Text style={styles.profileNameStyle} > {this.props.propuser} </Text>
                        <Text></Text>
